...
# Load NVIDIA configuration from persistent storage
...
NVIDIA_PROVIDER = NvidiaProvider(api_key=nvidia_api_key)
...
from routes.api import (
    list_models, v1_models, process_task, generate, chat, get_stats, performance_test, health_check, classify_only,
    get_config as get_config_handler, get_fallbacks as get_fallbacks_handler, set_ollama_target as set_ollama_handler,
    set_fallbacks as set_fallbacks_handler, get_requests, clear_requests, initialize as initialize_api
)
